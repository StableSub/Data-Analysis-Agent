...
import { Moon, Paperclip, Send } from 'lucide-react';
 ...
 * 피그마 디자인 참고용
 */
export function SimplifiedVisualization() {
  return (
      ...
      <div className="flex-1 flex flex-col bg-white dark:bg-[#1c1c1e]">
        ...
        <div className="bg-white dark:bg-[#2c2c2e] border-b border-gray-200 dark:border-white/10 px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-xl text-gray-900 dark:text-white">데이터 시각화</h1>
            ...
            <div className="max-w-2xl mx-auto text-center space-y-8">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 pt-8 border-t border-gray-200 dark:border-white/10">
                <div className="text-center space-y-2">
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400">선형 차트</p>
                </div>
                <div className="text-center space-y-2">
                  <div className="text-3xl">📊</div>
                  <p className="text-xs text-gray-600 dark:text-gray-400">막대 그래프</p>
                </div>
                <div className="text-center space-y-2">
                  <div className="text-3xl">🥧</div>
                  <p className="text-xs text-gray-600 dark:text-gray-400">원형 차트</p>
                </div>
                <div className="text-center space-y-2">
                  <div className="text-3xl">📉</div>
                  <p className="text-xs text-gray-600 dark:text-gray-400">산점도</p>
                </div>
              </div>
            </div>
          </div>
