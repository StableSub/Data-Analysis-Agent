...
from backend.app.ai.agents.state import GuidelineGraphState
from backend.app.domain.guideline.repository import GuidelineRepository
from backend.app.rag.core.embedding import E5Embedder
from backend.app.rag.guideline_repository import GuidelineRagRepository
from backend.app.rag.service import GuidelineRagService
...
def build_guideline_workflow(*, db: Session, default_model: str = "gpt-5-nano"):
    ...
    guideline_rag_service = GuidelineRagService(
        ...
        storage_dir=Path("storage") / "guideline_vectors",
