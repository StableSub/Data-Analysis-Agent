...
export function StatusBadge({ status, className }: StatusBadgeProps) {
  const config = {
    ...
    ready: { label: "Ready", color: "bg-[var(--genui-running)]/10 text-[var(--genui-running)] border-[var(--genui-running)]/20" },
    ...
    success: { label: "Complete", color: "bg-[var(--genui-success)]/10 text-[var(--genui-success)] border-[var(--genui-success)]/20" },
  };
